...
exports.clarityByteToType = exports.clarityTypeToByte = exports.ClarityWireType = exports.ClarityType = void 0;
var ClarityType;
...
})(ClarityWireType || (exports.ClarityWireType = ClarityWireType = {}));
function clarityTypeToByte(type) {
    return ClarityWireType[type];
}
exports.clarityTypeToByte = clarityTypeToByte;
function clarityByteToType(wireType) {
    return ClarityWireType[wireType];
}
exports.clarityByteToType = clarityByteToType;
