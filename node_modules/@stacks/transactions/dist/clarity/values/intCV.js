...
const intCV = (value) => {
    if (typeof value === 'string' && value.toLowerCase().startsWith('0x')) {
        value = (0, common_1.bytesToTwosBigInt)((0, common_1.hexToBytes)(value));
    }
    if ((0, common_1.isInstance)(value, Uint8Array))
        value = (0, common_1.bytesToTwosBigInt)(value);
    const bigInt = (0, common_1.intToBigInt)(value);
    if (bigInt > MAX_I128) {
