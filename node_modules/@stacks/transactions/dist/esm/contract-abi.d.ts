...
export type ClarityAbiTypePrimitive = ClarityAbiTypeUInt128 | ClarityAbiTypeInt128 | ClarityAbiTypeBool | ClarityAbiTypePrincipal | ClarityAbiTypeTraitReference | ClarityAbiTypeNone;
export type ClarityAbiType = ClarityAbiTypePrimitive | ClarityAbiTypeBuffer | ClarityAbiTypeResponse | ClarityAbiTypeOptional | ClarityAbiTypeTuple | ClarityAbiTypeList | ClarityAbiTypeStringAscii | ClarityAbiTypeStringUtf8 | ClarityAbiTypeTraitReference;
...
export declare function encodeAbiClarityValue(value: string, type: ClarityAbiType | ClarityAbiTypeUnion): ClarityValue;
export declare function encodeClarityValue(type: ClarityAbiType, value: string): ClarityValue;
export declare function encodeClarityValue(type: ClarityAbiTypeUnion, value: string): ClarityValue;
