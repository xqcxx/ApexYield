...
exports.parseToCV = exports.validateContractCall = exports.abiFunctionToString = exports.getTypeString = exports.encodeClarityValue = exports.encodeAbiClarityValue = exports.getTypeUnion = exports.isClarityAbiList = exports.isClarityAbiTuple = exports.isClarityAbiOptional = exports.isClarityAbiResponse = exports.isClarityAbiStringUtf8 = exports.isClarityAbiStringAscii = exports.isClarityAbiBuffer = exports.isClarityAbiPrimitive = exports.ClarityAbiTypeId = void 0;
...
function encodeAbiClarityValue(value, type) {
    ...
    switch (union.id) {
        case ClarityAbiTypeId.ClarityAbiTypeUInt128:
            return (0, clarity_1.uintCV)(value);
        case ClarityAbiTypeId.ClarityAbiTypeInt128:
            return (0, clarity_1.intCV)(value);
        ...
        case ClarityAbiTypeId.ClarityAbiTypePrincipal:
            if (value.includes('.')) {
                ...
                return (0, clarity_1.standardPrincipalCV)(value);
            }
        ...
        case ClarityAbiTypeId.ClarityAbiTypeBuffer:
            return (0, clarity_1.bufferCV)((0, common_1.hexToBytes)(value));
        case ClarityAbiTypeId.ClarityAbiTypeStringAscii:
            return (0, clarity_1.stringAsciiCV)(value);
        case ClarityAbiTypeId.ClarityAbiTypeStringUtf8:
            return (0, clarity_1.stringUtf8CV)(value);
        case ClarityAbiTypeId.ClarityAbiTypeOptional:
            return (0, clarity_1.someCV)(encodeAbiClarityValue(value, union.type.optional));
...
exports.encodeAbiClarityValue = encodeAbiClarityValue;
function encodeClarityValue(type, value) {
    const union = type.id
        ? type
        : getTypeUnion(type);
    if (union.id === ClarityAbiTypeId.ClarityAbiTypeBuffer) {
        return (0, clarity_1.bufferCV)((0, common_1.utf8ToBytes)(value));
    }
    ...
    switch (cv.type) {
        ...
        case clarity_1.ClarityType.Tuple:
            if (union.id == ClarityAbiTypeId.ClarityAbiTypeTuple) {
                const tuple = (0, utils_1.cloneDeep)(cv.value);
